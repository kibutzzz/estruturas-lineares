...
class EstoqueTest {
  ...
  void naoDeveAdicionarProdutosNulo() {
    final var exception = assertThrows(IllegalArgumentException.class, () -> estoque.adicionarProduto(null));
  ...
  void naoDeveAdicionarProdutoComCodigoRepetido() {
    ...
    final var exception = assertThrows(IllegalArgumentException.class, () -> estoque.adicionarProduto(feijao));
  ...
  void naoDevePoderAlterarQuantidadeParaMenosQueZero() {
    ...
    estoque.adicionarProduto(batata);
    final var exception = assertThrows(IllegalArgumentException.class, () -> estoque.alterarQuantidadeDeProduto("1", -1));
